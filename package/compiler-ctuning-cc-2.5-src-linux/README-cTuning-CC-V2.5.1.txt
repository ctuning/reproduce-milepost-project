Note, that this is rather outdated package converted to CK
for legacy reasons (to be able to reproduce our past research).

We are now implementing machine-learning based compilation and
optimization for the latest GCC and LLVM using CK autotuning
workflows from ck-autotuning repo. Your help is appreciated!
